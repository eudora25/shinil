...
def fix_18_local():
    """18번 파일을 로컬 API 응답 구조에 맞게 수정합니다."""
    ...
    try:
        ...
        print("=== 18번 파일을 로컬 API 응답 구조로 수정 시작 ===")
        ...
        if output_section_row:
            ...
            new_output_params = [
                ...
                ["data[].absorption_rate", "NUMERIC", "흡수율", "Y", "매출 흡수율"],
                ["data[].analysis_time", "STRING", "분석시간", "N", "분석 완료 시간"],
