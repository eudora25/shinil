// Express.js 라우터 형식으로 변경 (12_병원업체_매핑정보.xlsx 형식에 맞춤)
...
// GET /api/client-company-assignments - 병원-업체 매핑정보 조회 (12_병원업체_매핑정보.xlsx 형식에 맞춤)
// Bearer Token 인증 필요
...
=======
    ...
    if (error) {
      console.error('Client-company assignments query error:', error)
      return res.status(500).json({
        success: false,
        message: '병원-업체 매핑 정보 목록 조회 중 오류가 발생했습니다.',
        error: error.message
      })
    }
