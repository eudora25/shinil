...
def fix_14_file():
    """14번 파일을 실제 API 응답 구조에 맞게 수정합니다."""
    
    try:
        # 엑셀 파일 로드
        wb = load_workbook('API_Files/14_제품업체_미배정매핑.xlsx')
        ws = wb.active
        
        print("=== 14번 파일을 실제 API 응답 구조로 수정 시작 ===")
        ...
        if output_section_row:
            ...
            # 파일 저장
            wb.save('API_Files/14_제품업체_미배정매핑.xlsx')
            print("14번 파일 수정이 완료되었습니다.")
