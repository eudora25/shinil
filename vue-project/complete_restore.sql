-- Shinil PMS Complete Data Restoration
-- 모든 데이터를 한번에 복원하는 완전한 스크립트
...
DELETE FROM auth.users WHERE email IN (
    'admin@admin.com', 'user1@user.com', 'user2@user.com', 'user3@user.com',
    'tt1@tt.com', 'moonmvp@twosun.com', 'sjchoi@twosun.com', 'd1@123.com'
);
...
-- 7. 복원 완료 확인
SELECT 'Complete Data Restoration Summary' as status;
